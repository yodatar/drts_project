Real-Time Manipulation Technique for Web Applications over Wi-Fi Using Smartphone
=================================================================================
...
Hundrets of millions of smartphones have been sold since their introduction in 2007. Today’s mobile devices are possessing high computational power and microelectromechanical systems (sensors) on board. These properties contribute to the user experience by on-device adaptations, supporting useful applications and more. Developers have used these sensors to tailor them also for use in remote control.
